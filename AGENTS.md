...
config/board-theme.css config/board-logo.svg  optional home-local theme and logo the /bearings lavish board is built with, in place of the tracked neutral defaults; LOCAL, gitignored; see docs/configuration.md "Fleet board theme"
